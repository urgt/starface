...
/**
 * Bulk regenerate: delegates to the async ML job queue.
 * Returns immediately with the number of jobs enqueued.
 * Clients should subscribe to /api/admin/describe/events for progress.
 */
